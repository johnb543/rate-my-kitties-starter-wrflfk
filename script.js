...
function updateKittyInfo(index) {
  ...
  document.getElementById('my-banner').src = IMAGES[currentIndex + 1];
  // TODO: Update the Title of the image here. Hint: Use `innerHTML` property instead of `src`.
  document.getElementById('kitty-title').innerHTML =
    IMAGE_TITLES[currentIndex + 1];
